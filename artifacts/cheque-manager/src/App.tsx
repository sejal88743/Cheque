...
import { Landmark, FileText, Settings as SettingsIcon, Database } from "lucide-react";
      ...
      <header className="sticky top-0 z-10 bg-primary text-primary-foreground shadow-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-1 sm:gap-3">
            ...
            <Link href="/bills" className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${location === '/bills' ? 'bg-primary-foreground/10 text-white' : 'text-primary-foreground/70 hover:text-white hover:bg-primary-foreground/5'}`}>
